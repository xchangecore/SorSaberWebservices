...
public class IconService {
    ...
    public void updateIcons() {
        ...
        if (WebserviceController.IconsLastQueryTime.plusSeconds(WebserviceController.IconsTimeoutForceSeconds).isBefore(now()))
        {
            ...
            logger.info("Timer has not expired, not able to force icon map update");
        }
    }
};
